...
export const CustomersSales = () => {
  ...
  const [customer, setCustomer] = useState({ name: "", phone: "", email: "", address: "", credit_limit: 0, lifetime_revenue: 0, lifetime_profit: 0 });
  ...
  const resetCustomer = () => { setCustomer({ name: "", phone: "", email: "", address: "", credit_limit: 0, lifetime_revenue: 0, lifetime_profit: 0 }); setEditingId(null); setCustomerError(""); };
            ...
            <TableContainer>
              <Table size="small">
                ...
                <TableBody>
                  ...
                  {!products.length && <TableRow><TableCell colSpan={4} align="center" sx={{ py: 3, color: "text.secondary" }}>No sales data yet</TableCell></TableRow>}
                </TableBody>
              </Table>
            </TableContainer>
          </CardContent>
